...
Here is an example that you can consider to compare the model and the expected outcome of the np package. We can see that the results are pretty much related to each other and the differences are not that much.
